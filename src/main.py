...
from .window import NyarchcustomizeWindow


class NyarchcustomizeApplication(Adw.Application):
    ...
    def do_activate(self):
        ...
        if not win:
            win = NyarchcustomizeWindow(application=self)
        win.present()
...
def main(version):
    ...
    app = NyarchcustomizeApplication()
